...
num_rows_per_process = width // size
remaining_rows = width % size

if rank < remaining_rows:
    start_row = rank * (num_rows_per_process + 1)
    end_row = start_row + num_rows_per_process + 1
else:
    start_row = rank * num_rows_per_process + remaining_rows
    end_row = start_row + num_rows_per_process
...
if rank == 0:
    ...
    plt.imsave('image3.png', final_image)
    end_time = MPI.Wtime()
